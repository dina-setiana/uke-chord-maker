...
class SongHelper
{
    ...
    public static  function parseSong($text)
    {
        ...
        $song->isOK = true;
        $song->title = self::_getTitle($text);
        $song->subtitle = self::_getSubtitle($text);
        $song->artist = self::_getArtist($text);
        $song->album = self::_getAlbum($text);
        $song->meta = self::_getMeta($text);
        $song->body = $text;
     ...
     * @return string
     */
    private static function _getTitle($text)
    {
     ...
     * @return string
     */
    private static function _getSubtitle($text)
    {
     ...
     * @return string
     */
    private static function _getArtist($text)
    {
     ...
     * @return string
     */
    private static function _getAlbum($text)
    {
     ...
     * @return string
     */
    private static function _getMeta($text)
    {
        $rtn = array();
